...
data = json.loads((ROOT/"src/data/innovation.json").read_text())
geo  = json.loads((ROOT/"src/data/nuts3_paths.json").read_text())
m = data["meta"]
...
(ROOT/"innovazione.html").write_text(html, encoding="utf-8")
